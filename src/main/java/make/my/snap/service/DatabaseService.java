...
import make.my.snap.data.PlayerStats;
import make.my.snap.data.ViolationRecord;
...
public class DatabaseService {
    ...
    public DatabaseService(SnapAI plugin) {
        this.plugin = plugin;
    }

    public void init() {
        File dbFile = new File(plugin.getDataFolder(), "snapai.db");
